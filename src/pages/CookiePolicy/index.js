                ...
                <Row>
                    <Col md="12">
                        <div className='inner_main'>
                            <h2>Cookie Policy for Raffle</h2>
                            <p>This is the Cookie Policy for Raffle , accessible from https://raffle.upcomingnft.net/</p>
                            ...
                            <ul className='inner_list'>
                                <li>
                                    <span>Email:</span> support@upcomingnft.net
                                </li>
                            </ul>
                        </div>
                    </Col>
